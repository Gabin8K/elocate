    ...
    <div className="flex flex-col h-screen w-screen p-8 pb-20 gap-16 sm:p-20 bg-black text-white">
      <main className="flex flex-col h-full w-full items-center">
        <h1 className="flex flex-col w-full">
          <span className="text-4xl">Bienvenue sur </span>
          <div className="flex items-center text-[60px]">
            <span className="font-extrabold">EL</span>
            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 24 24"><path fill="#1DA445" fillRule="evenodd" d="m12.065 21.243l-.006-.005zm.182-.274a29 29 0 0 0 3.183-3.392c2.04-2.563 3.281-5.09 3.365-7.337a6.8 6.8 0 1 0-13.591 0c.085 2.247 1.327 4.774 3.366 7.337a29 29 0 0 0 3.183 3.392q.166.15.247.218zm-.985 1.165S4 16.018 4 10a8 8 0 1 1 16 0c0 6.018-7.262 12.134-7.262 12.134c-.404.372-1.069.368-1.476 0M12 12.8a2.8 2.8 0 1 0 0-5.6a2.8 2.8 0 0 0 0 5.6m0 1.2a4 4 0 1 1 0-8a4 4 0 0 1 0 8" /></svg>
            <span className="font-extrabold">CATE</span>
          </div>
        </h1>
        <div className="flex flex-col flex-[1] justify-center items-center gap-8">
          <p className="text-center text-lg sm:text-xl">
            Téléchargez notre application mobile pour ajouter des lieux sur une carte et naviguer facilement.
          </p>
          <div className="flex flex-col lg:flex-row gap-4">
            <Link
              href="https://play.google.com/store/apps/details?id=com.elocate"
              className="flex items-center bg-white text-black hover:bg-gray-200 font-bold py-2 px-4 rounded"
            >
